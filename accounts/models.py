...
class LoanConfig(models.Model):
    ...
    interest_rate_monthly = models.DecimalField(
        max_digits=10, decimal_places=6, default=Decimal("0.004000")
    )
    min_amount = models.DecimalField(
        max_digits=14, decimal_places=2, default=Decimal("30000000.00")
    )
    max_amount = models.DecimalField(
        max_digits=14, decimal_places=2, default=Decimal("100000000.00")
    )
